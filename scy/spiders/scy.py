...
from scy.items import DingdianItem ##这是我定义的需要保存的字段，（导入dingdian项目中，items文件中的DingdianItem类）
from scy.items import DcontentItem
from scy.mysqlpipelines.sql import Sql
...
class Myspider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for num in range(1, int(3) + 1):#max_num
    ...
    def get_chapterurl(self, response):
        ...
        name_id = str(item['novelurl'])[-10:-5].replace('/', '')
